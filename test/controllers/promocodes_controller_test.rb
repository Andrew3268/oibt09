...
class PromocodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promocode" do
    assert_difference('Promocode.count') do
      post promocodes_url, params: { promocode: { code_hashtag: @promocode.code_hashtag, code_title: @promocode.code_title } }
    end
  ...
  test "should update promocode" do
    patch promocode_url(@promocode), params: { promocode: { code_hashtag: @promocode.code_hashtag, code_title: @promocode.code_title } }
